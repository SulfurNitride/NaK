...
class GameInfoView(QWidget):
    ...
    def _create_fnv_view(self):
        ...
        if fnv_detected:
            ...
            if steam_root:
                ...
                deps_text = QTextEdit()
                deps_text.setPlainText("• xact\n• xact_x64\n• d3dx9_43\n• d3dx9\n• vcrun2022\n• fontsmooth=rgb (via registry)")
    ...
    def _setup_fnv_dependencies(self):
        ...
        self._setup_dependencies("22380", ["xact", "xact_x64", "d3dx9_43", "d3dx9", "vcrun2022"])
        
    def _setup_enderal_dependencies(self):
        """Setup Enderal dependencies"""
        self._setup_dependencies("976620", ["xact", "xact_x64", "d3dx11_43", "d3dcompiler_43", "d3dcompiler_47", "vcrun2022", "dotnet6", "dotnet7", "dotnet8"])
