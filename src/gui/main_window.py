...
class MainWindow(QMainWindow):
    def __init__(self, core):
        ...
        main_layout.addWidget(self.stacked_widget, 1)  # Give it stretch factor 1

        # Initialize views
        self._create_views()

        # Create bottom toolbar for settings
    ...
    def _create_bottom_toolbar(self, parent_layout):
        """Create bottom toolbar with settings button"""
    ...
    def show_settings(self):
        ...
        try:
            ...
            self.setWindowTitle("NaK - Linux Modding Helper - Settings")
    ...
    def show_game_finder(self):
        """Show the game finder view"""
        try:
            self.stacked_widget.setCurrentWidget(self.game_finder_view)
            self.game_finder_view.on_show()
            self.setWindowTitle("NaK - Linux Modding Helper - Light Modifications")
            self.logger.info("Switched to view: game_finder")
        except Exception as e:
            self.logger.error(f"Failed to show game finder: {e}")
