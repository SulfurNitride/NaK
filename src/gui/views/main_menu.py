...
class MainMenuView(QWidget):
    ...
    def _create_widgets(self):
        ...
        # Create horizontal button layout (side-by-side)
        button_layout = QHBoxLayout()
        button_layout.setSpacing(30)
        button_layout.addStretch()

        # Create the Mod Managers button
        mod_managers_button = QPushButton("Mod Managers")
        mod_managers_button.setStyleSheet("""
            QPushButton {
        ...
        """)
        mod_managers_button.clicked.connect(self.controller.show_mod_managers)
        button_layout.addWidget(mod_managers_button)

        # Create the Light Modifications button
        light_mods_button = QPushButton("Light Modifications")
        light_mods_button.setToolTip("Making modding on Linux nice.")
        light_mods_button.setStyleSheet("""
            QPushButton {
        ...
        """)
        light_mods_button.clicked.connect(self.controller.show_game_finder)
        button_layout.addWidget(light_mods_button)
