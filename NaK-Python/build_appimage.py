...
def build_appimage():
    ...
    # Copy AppDir files
    shutil.copy("AppDir/AppRun", appdir)
    shutil.copy("AppDir/nak.desktop", appdir)
    ...
    shutil.copy("main_appimage.py", usr_bin / "main_appimage.py")
    ...
    run_command([
        appimagetool_path, str(appdir), "NaK-Linux-Modding-Helper-x86_64.AppImage"
    ])
