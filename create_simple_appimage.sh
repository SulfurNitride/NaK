...
echo "Creating Simple System Python AppImage..."
...
if command -v appimagetool &> /dev/null; then
    ARCH=x86_64 appimagetool AppDir NaK-Linux-Modding-Helper-Simple.AppImage
    echo "AppImage created: NaK-Linux-Modding-Helper-Simple.AppImage"
    ls -lh NaK-Linux-Modding-Helper-Simple.AppImage
else
